...
class FullRouteMixedFleetSelectorSpec extends Specification {
	...
	def "Get quality - empty route"() {
		...
		routeReport.getSummary().pickupLoad = 0
		routeReport.getSummary().delivery = 0
		routeReport.getSummary().delay = 0
	...
	def "Get best routes - normal"() {
		...
		routeReport1.getSummary().pickupLoad = 555
		routeReport1.getSummary().delivery = 666
		...
		routeReport2.getSummary().pickupLoad = 555
		routeReport2.getSummary().delivery = 666
		...
		routeReport3.getSummary().pickupLoad = 555
		routeReport3.getSummary().delivery = 666
		...
		routeReport4.getSummary().pickupLoad = 555
		routeReport4.getSummary().delivery = 666
