 ...
 *
 */
public abstract class DepotData implements Serializable{
	private static final long serialVersionUID = 5178497283872410604L;
	 ...
	 */
	public DepotData setOpen3(float open3) {
		this.open3 = open3;
		return this;
	}
	 ...
	 */
	public DepotData setClose3(float close3) {
		this.close3 = close3;
		return this;
	}
